    ...
    <div class="page-main">
        ...
        <div id="list-resource" class="post-body">
            ...
            <div class="entry-padding">
                <h2 class="post-title">
                    <a href="${pagetext.request.contextPath}/FirstDownServlet?name=${resource.name}&type=${resource.type}&filename=${resource.saveFileName}&fileName=${resource.fileName}">${resource.name}</a>
                </h2>
